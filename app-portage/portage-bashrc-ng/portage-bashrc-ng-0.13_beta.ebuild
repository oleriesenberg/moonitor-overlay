...
pkg_postrm() {
	echo ""
	echo ""
	ewarn "I'm now going to remove /etc/portage/bashrc in spite of config_protect."
	ewarn "This is neccessary to ensure Portage's integrity."
	ewarn "Press CTRL+C now to abort and remove /etc/portage/bashrc manually."
	echo ""
	echo ""
	epause 10
