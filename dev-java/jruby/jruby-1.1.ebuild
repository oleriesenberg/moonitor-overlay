...
src_compile() {
	eant jar $(use_doc create-apidocs) -Djruby.home="${T}"/.jruby -Djdk1.5+=true
}
...
src_install() {
	...
	java-pkg_dolauncher ${PN} \
		--main 'org.jruby.Main' \
		--java_args '${JAVA_OPTS} -Djruby.base=/usr/share/jruby
		-Djruby.home=/usr/share/jruby -Djruby.lib=/usr/share/jruby/lib -Djruby.script=jruby -Djruby.shell=/bin/sh' \
		-pre ${FILESDIR}/${P}_launcher
	dobin "${S}"/bin/jirb
